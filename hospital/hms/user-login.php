	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2 class="text-center"> Dental Care | Patient Login</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							...
							<div class="form-actions">
								...
								<button type="submit" class="btn btn-primary col-lg-12" name="submit">
									Sign In
								</button>
							</div>
					...
					<div class="copyright">
						</span><span class="text-bold text-uppercase"> Dental Care</span>.
					</div>

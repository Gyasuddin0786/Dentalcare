									...
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
											...
											<tr>
												...
												<a href="manage-doctors.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" 

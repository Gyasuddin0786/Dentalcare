...
<?php
    ...
    ?>    
    <!-- privacy and policy section starts from here -->
    <div class="container-fluid mt-5 border border-danger">
        <div class="row">
            <div class="col-md-12 col-lg-12">
            <h1 class="mt-5 text-center">Privacy Policy for  Dental Care</h1>
            <p>At rajkotdentist, accessible from rajkotdentist.com, one of 
                our main priorities is the privacy of our visitors. This Privacy Policy document 
                contains types of information that is collected and recorded by rajkotdentist and how we use it.</p>
                <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.</p>
                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                     website with regards to the information that they shared and/or collect in rajkotdentist.
                     ...
                     created with the help of the Free <a href="#" class="text-decoration-none">Privacy Policy Generator.</a></p>
            <h5>Consent</h5>
            ...
            <p>When you register for an Account, we may ask for your contact information, including items such as name, company name, address,
            ...
            <h4>Log Files</h4>
            <p>rajkotdentist follows a standard procedure of using log files. 
            ...
            <p>Like any other website, rajkotdentist uses ‘cookies’. These cookies are used to store information including visitors’ 
            ...
            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of rajkotdentist.</p>
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are 
                used in their respective advertisements and links that appear on rajkotdentist, which are sent directly to users’ browser.
                 They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising 
                campaigns and/or to personalize the advertising content that you see on websites that you visit.</p>
            <h3>Third-Party Privacy Policies</h3>
            <p>rajkotdentist’s Privacy Policy does not apply to other advertisers or websites. 
            ...
            <p>rajkotdentist does not knowingly collect any Personal Identifiable Information from children under the age of 13.
    ...
    <!-- privacy and policy section ends from here -->
    <?php
